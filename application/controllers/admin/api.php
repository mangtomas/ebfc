...
class api extends crackerjack{
	...
	public function modules(){
		...
		//$result = $this->crud->read('SELECT * FROM _module,_module_label WHERE module_id != 1 AND _module.reference_id=_module_label.label_id',array(),'obj');
		//echo "aaData:["json_encode($result)."]";
	
		$sOutput = '{';
	$sOutput .= '"sEcho": 0, ';
	$sOutput .= '"iTotalRecords": 1, ';
	$sOutput .= '"iTotalDisplayRecords": '.$iFilteredTotal.', ';
	$sOutput .= '"aaData": [ ';
	$sOutput .= json_encode($result);
	$sOutput .= '"]} ';
		echo $sOutput;
	}
	 ...
	 */
	$aColumns = array( 'module_id', 'module', 'url' );
