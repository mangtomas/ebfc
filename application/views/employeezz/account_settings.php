...
<?=isset($success) ? $success : null;?>
	...
	<form action="<?=base_url('admin/account/settings')?>" method="POST" class="form-horizontal" id="validate-form">
		<fieldset>
...
<form action="<?=base_url('admin/account/settings')?>" method="POST" class="form-horizontal" id="validate-form2">
	<fieldset>
