...
<?=isset($success) ? $success : null;?>
	...
	<form action="<?=base_url('admin/account/information/modify')?>" method="POST" class="form-horizontal" id="validate-form" enctype="multipart/form-data">
				...
				<div class="action-btn-container" style="margin-top:20px">
					<a href="<?=base_url('admin/account/information/modify')?>" >Edit information</a>
				</div>
				</div>
