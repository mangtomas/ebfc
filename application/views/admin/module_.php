...
<legend class="module-title"><i class="custom-icon-info" style="margin-top:-3px"></i><?=(strtolower($action)=='edit') ? 'Update' : $action ?> Module</legend>
	<a href="<?=base_url('admin/module')?>" class="btn btn-small" ><i class="icon-circle-arrow-left"></i> Back</a>
	<form action="<?=base_url('admin/module/'.strtolower($action))?>" method="POST" class="form-horizontal" id="role-form">
			<?php
