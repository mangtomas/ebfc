...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Eastern Blends Food Corporation - Attendance Monitoring with Payroll System Using Biometric Device and Image Identification</title>
    ...
    <link href="<?=base_url()?>assets/css/google-datepicker.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="<?=base_url()?>admin" style="padding: 2px 20px;">Eastern Blends Food Corporation <small class="brand-qoute" style="line-height:15px">Attendance Monitoring with Payroll System Using Biometric Device</small></a>
            ...
            <ul class="nav">
              ...
              <li class="dropdown active dropdown-info">
                ...
                <ul class="dropdown-menu ">
                  ...
                  <li><a href="<?=base_url('admin/main/incident-report')?>"><i class="icon-cog"></i> Incident Report</a></li>
				   <li class="divider"></li>
				  	<?php
					if(count($data['nagivation']) != 0){
						foreach($data['nagivation'] as $k => $v){
							?>
							<li><a href="<?=base_url()?>admin/<?=$v['url']?>"><i class="icon-list"></i> <?=$v['module']?></a></li>
							<?php
						}
					}		  
					 ?>
    ...
    width: 20px;"><?=ucwords($info['firstname'])." ".ucwords($info['lastname'])?> <b class="caret"></b></a>
                <ul class="dropdown-menu ">
				    ...
				    <li class="divider"></li>
                  <li><a href="<?=base_url('admin/account/information/modify')?>"><i class="icon-info-sign"></i> Account Information</a></li>
                  <li><a href="<?=base_url('admin/account/settings')?>"><i class="icon-cog"></i> Account Settings</a></li>
				    <li class="divider"></li>
