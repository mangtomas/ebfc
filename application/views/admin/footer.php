	<br style="clear:both" />
	<!--
	<footer style="width:1170px;margin:0 auto"><small>Copyright EBFC 2013</small></footer>
   </div>  /container -->
    <div id="push"></div>
    </div>

 <div id="footer" style="padding:5px auto">
      <div class="container" style="text-align:center;">
	  <br />
	  <strong>Eastern Blends Food Corporation</strong> <br />
	  Attendance Monitoring with Payroll System Using Biometric Device and Image Identification
	  <br />
	  <small>copyright ebfc 2013</small><br />
       </div>
    </div>
    <!-- Le javascript
    ================================================== -->
    ...
    <script src="<?=base_url()?>assets/js/jquery.alphanumeric.js"></script>
    <script src="<?=base_url()?>assets/js/jquery.form.js"></script>
    <script src="<?=base_url()?>assets/js/jquery.validate.js"></script>
    <script src="<?=base_url()?>assets/js/jquery.maskedinput.js"></script>
    <script src="<?=base_url()?>assets/js/jmethods.js"></script>
